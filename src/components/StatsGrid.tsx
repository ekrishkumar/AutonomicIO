          ...
          {stats.map((stat, idx) => {
            ...
            return (
              <div
                ...
                className="relative text-left p-8 border border-[#E2E8F0] dark:border-[#222630] bg-white dark:bg-[#181B22] transition-all duration-300 flex flex-col justify-between min-h-[320px] overflow-hidden rounded-xl group n8n-glow-hover"
              >
                ...
                <div className="mt-8 pt-4 border-t border-[#E2E8F0] dark:border-[#222630]/60 space-y-4 relative z-10">
                  ...
                  <div className="flex items-center justify-between text-[9px] uppercase tracking-[0.15em] font-bold text-black/40 dark:text-white/40">
                    ...
                    <button
                      ...
                      className="text-[#FF5C43] font-bold flex items-center gap-0.5 hover:underline cursor-pointer bg-transparent border-none p-0"
                    >
